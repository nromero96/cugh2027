...
class InvitationController extends Controller
{
    ...
    private function generateInvitationPDF(Invitation $invitation)
    {
        ...
        $content = <<<EOD
            ...
            <p style="text-align: justify;">Es grato dirigirme a usted para invitarle muy cordialmente a participar en la <b><i>18<sup>th</sup> Annual Conference CUGH 2027 Transforming Global Health:</i></b> <i>Partnerships, power, leadership and technology in a rapidly changing world;</i> conferencia que se realizará en la ciudad de Lima, del 25 al 28 de febrero de 2027.</p>
            ...
            <p style="text-align: justify;">La presente invitación se emite con el fin de apoyar su solicitud de visa para ingresar al Perú. Cabe señalar que los organizadores del evento no asumirán responsabilidad financiera por gastos de viaje, alojamiento u otros relacionados con su visita.</p>
            <p style="text-align: justify;">Esperamos que esta invitación encuentre en Ud. favorable acogida que le permita disfrutar de un encuentro con profesionales, investigadores y líderes en salud global de todo el mundo, con el objetivo de intercambiar conocimientos y fortalecer la colaboración internacional. </p>
