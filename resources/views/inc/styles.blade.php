    <link href="{{ asset('layouts/vertical-light-menu/css/light/loader.css') }}?v={{ config('app.version') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('layouts/vertical-light-menu/css/dark/loader.css') }}?v={{ config('app.version') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('bootstrap/css/bootstrap.min.css') }}?v={{ config('app.version') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/light/elements/tooltip.css') }}?v={{ config('app.version') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/dark/elements/tooltip.css') }}?v={{ config('app.version') }}" rel="stylesheet" type="text/css" />
    ...
    @switch($page_name)
        @case('dashboard')
            {{-- Dashboard --}}
            <link href="{{ asset('plugins/src/apex/apexcharts.css') }}?v={{ config('app.version') }}" rel="stylesheet" type="text/css">
        ...
        @case('works')
            ...
            <link rel="stylesheet" type="text/css" href="{{asset('plugins/css/light/table/datatable/custom_dt_custom.css')}}?v={{ config('app.version') }}">

            <link rel="stylesheet" type="text/css" href="{{asset('assets/css/light/apps/works-list.css')}}?v={{ config('app.version') }}">
            <link rel="stylesheet" type="text/css" href="{{asset('assets/css/dark/apps/works-list.css')}}?v={{ config('app.version') }}">
        ...
        @case('inscriptions')
            ...
            <link rel="stylesheet" type="text/css" href="{{asset('assets/css/light/apps/inscriptions-list.css')}}?v={{ config('app.version') }}">
            <link rel="stylesheet" type="text/css" href="{{asset('assets/css/dark/apps/inscriptions-list.css')}}?v={{ config('app.version') }}">
            @break
        ...
        @case('beneficiarios_becas')
            ...
            <link rel="stylesheet" type="text/css" href="{{asset('assets/css/light/apps/beneficiarios_becas-list.css')}}?v={{ config('app.version') }}">
            <link rel="stylesheet" type="text/css" href="{{asset('assets/css/dark/apps/beneficiarios_becas-list.css')}}?v={{ config('app.version') }}">
            @break
        ...
        @case('users')
            ...
            <link rel="stylesheet" type="text/css" href="{{asset('plugins/css/light/table/datatable/dt-global_style.css')}}">
            <link rel="stylesheet" type="text/css" href="{{asset('plugins/css/light/table/datatable/custom_dt_custom.css')}}"> --}}
            <link rel="stylesheet" type="text/css" href="{{asset('assets/css/light/apps/users-list.css')}}?v={{ config('app.version') }}">
            <link rel="stylesheet" type="text/css" href="{{asset('assets/css/dark/apps/users-list.css')}}?v={{ config('app.version') }}">
            {{-- <link rel="stylesheet" type="text/css" href="{{asset('plugins/css/dark/table/datatable/dt-global_style.css')}}"> --}}
