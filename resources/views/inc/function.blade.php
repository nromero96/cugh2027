...
if (!function_exists('setTitle')) :
    function setTitle($page_name) {
        ...
        $admin_name = ' | CUGH 2027';

        if ($page_name === 'dashboard') :
            echo __('Dashboard') . $admin_name;
        //Int. Admin
        elseif ($page_name === 'users'):
            echo __('Users') . $admin_name;
        elseif ($page_name === 'userscreate'):
        ...
        elseif ($page_name === 'rolecreate'):
            echo __('Add Role') . $admin_name;
        elseif ($page_name === 'roleedit'):
            echo __('Edit Role') . $admin_name;
        ...
        elseif ($page_name === 'suppliercreate'):
            echo __('Add Suppliers') . $admin_name;
        elseif ($page_name === 'supplieredit'):
