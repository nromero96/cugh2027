                    ...
                    <div class="widget-header pt-4">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12 text-end">
                                <a href="https://cughlima2027.org/invitation-letter/" class="btn btn-primary mb-4 ms-3 me-3" target="_blank">Generate Invitation Letter</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @foreach ($invitations as $invitation)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{{ asset('storage/uploads/invitation_letters').'/'. $invitation->file_name}}" target="_blank" class="badge badge-light-primary text-start me-2 action-edit bs-tooltip" data-toggle="tooltip" data-placement="top" title="{{ __("View PDF") }}">
