    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            ...
            <p class="text-center text-muted mt-4 small">
                If you have any questions, please contact our support team at <a href="mailto:claudia.morales@upch.pe" class="text-primary fw-bold">claudia.morales@upch.pe</a>.
            </p>
