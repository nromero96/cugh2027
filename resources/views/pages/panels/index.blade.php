                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header pt-2">
                        <div class="row">
                            <div class="col-md-12">
                                <h4>
                                    {{ $rejectedPage ? 'Rejected Panels' : 'Panels' }}
                                </h4>
                            </div>
                        ...
                        <div class="row px-3">
                            ...
                            <div class="col-md-3 text-end mt-0">
                                @if(auth()->user()->hasRole('Administrador'))
                                    ...
                                    @endif
                                    <a href="{{ route('panels.exportexcel', ['list' => $rejectedPage ? 'rejected' : 'active']) }}" class="btn btn-success btn-sm" title="Export this panel list to Excel">
                    ...
                    <div class="widget-content widget-content-area pt-0">
                        @if(request()->filled('search'))
                            <p class="text-muted mb-2">
                                {{ $panels->total() }} {{ Str::plural('panel', $panels->total()) }} found.
                            </p>
                        @endif
                        ...
                        Total {{ $rejectedPage ? 'Rejected Panels' : 'Panels' }} <span class="badge bg-secondary ms-1">{{ $rejectedPage ? $rejectedPanelCount : $panelCount }}</span>
